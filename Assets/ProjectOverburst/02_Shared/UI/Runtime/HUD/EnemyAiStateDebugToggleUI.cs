...
public sealed class EnemyAiStateDebugToggleUI : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        CombatDebugSettings.EnemyAiStateDebugChanged += HandleSettingChanged;
        RefreshLabel();
    }
    ...
    private void Toggle()
    {
        CombatDebugSettings.ToggleEnemyAiStateDebug();
    }
    ...
    {
        if (label != null)
            label.text = CombatDebugSettings.ShowEnemyAiStateDebug
                ? "AI 상태 표시: 켜짐"
                : "AI 상태 표시: 꺼짐";
    }
